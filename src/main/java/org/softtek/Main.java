...
public class Main {
    ...
    public static List<Empleado> crearListaEmpleados()
    {
        ...
        empleados.add(new Empleado("Alfredo","Montaner",LocalDate.now().atStartOfDay(),List.of(),null));

        empleados.add(new Empleado("Ana","Gomez",LocalDate.now().atStartOfDay(),List.of("123456789"),empleados.get(0)));

        empleados.add(new Empleado("Luis",null,LocalDate.now().atStartOfDay(),List.of(),empleados.get(0)));

        empleados.add(new Empleado("Marta","Lopez",LocalDate.now().atStartOfDay(),List.of("111222333", "444555666"),empleados.get(1)));

        empleados.add(new Empleado("Carlos","Ruiz",LocalDate.now().atStartOfDay(),List.of(),empleados.get(1)));
        ...
        empleados.add(new Empleado("Pedro","Sanchez",LocalDate.now().atStartOfDay(),List.of(),empleados.get(5)));

        empleados.add(new Empleado("Lucia","Fernandez",LocalDate.now().atStartOfDay(),List.of("222333444"),empleados.get(0)));

        empleados.add(new Empleado("Diego","Torres",LocalDate.now().atStartOfDay(),List.of(),empleados.get(1)));
        return empleados;
    }
}